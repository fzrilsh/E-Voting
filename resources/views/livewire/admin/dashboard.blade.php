<main class="py-4 pr-4 sm:ml-64 pl-4 sm:pl-0">
    ...
    <section class="grid grid-cols-4 gap-4 mt-4">
        ...
        <div class="col-span-4 w-full">
            <div class="grid grid-cols-4 justify-items-center items-center gap-4 mx-auto">
                <a href="" class="col-span-1 flex flex-col items-center p-2 text-center gap-2 w-full bg-gray-100 py-4 rounded-lg">
    ...
    <!-- <div class="relative overflow-x-auto mt-4 bg-gray-100 rounded-md p-4"></div> -->
</main>