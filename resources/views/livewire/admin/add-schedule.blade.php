<main class="flex flex-col items-center justify-center mx-auto max-w-xl mb-5 py-4 pr-4 sm:ml-64 pl-4 sm:pl-0">
    <section class="flex flex-col justify-center items-center w-full">
        <form class="bg-gray-50 rounded-lg p-5 flex flex-col w-full">
            @error('error')
            ...
            <div class="flex flex-col text-gray-500 mb-4">
                ...
                <select id="candidates_ids" wire:model="candidates_ids" multiple class="bg-transparent border border-gray-400 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none focus:ring-1 focus:ring-carmine-500">
            ...
            <div class="flex flex-col text-gray-500 mb-4">
                ...
                <input type="datetime-local" name="start" id="start" wire:model="start" class="bg-transparent border border-gray-400 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none focus:ring-1 focus:ring-carmine-500" />
            </div>
            ...
            <div class="flex flex-col text-gray-500 mb-4">
                ...
                <input type="datetime-local" name="end" id="end" wire:model="end" class="bg-transparent border border-gray-400 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none focus:ring-1 focus:ring-carmine-500" />
            </div>
